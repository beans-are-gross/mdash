...
if (!$docker) {
    ...
    $createModuleTableQuery = mysqli_query($dbConn, "CREATE TABLE IF NOT EXISTS `mdash`.`modules` ( `id` INT NOT NULL AUTO_INCREMENT , `url`  VARCHAR(10000) NOT NULL , PRIMARY KEY (`id`));");
